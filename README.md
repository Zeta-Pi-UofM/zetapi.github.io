...
The live version of the site is deployed directly from `main`. Any and all changes should first be done in their respective branch, then merged to `main` via pull request.

An archived version of the historical site is available in the `legacy` branch.
